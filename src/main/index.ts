...
import { createTeleopBarWindow, showTeleopBarWindow, hideTeleopBarWindow, getTeleopBarWindow } from './windows/TeleopBarWindow.js';
...
function createTray() {
  ...
  const contextMenu = Menu.buildFromTemplate([
    ...
    },
    {
      ...
      checked: true,
      click: (menuItem) => {
        teleopEnabled = menuItem.checked;
        if (teleopEnabled) {
          showTeleopBarWindow();
        } else {
          hideTeleopBarWindow();
    ...
    },
    {
      ...
      submenu: [
        ...
        },
        {
          label: 'Pause/Resume',
          click: () => {
            const teleopWindow = getTeleopBarWindow();
            if (teleopWindow) {
              teleopWindow.webContents.send('teleop:toggle-pause');
            }
          },
        },
      ],
